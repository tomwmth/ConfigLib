...
public class ConfigurationProperties {
    ...
    protected ConfigurationProperties(Builder<?> builder) {
        this.serializersByType = Collections.unmodifiableMap(builder.serializersByType);
        this.serializerFactoriesByType = Collections.unmodifiableMap(builder.serializerFactoriesByType);
    ...
    public static abstract class Builder<B extends Builder<B>> {
         ...
         * @throws NullPointerException if any argument is null
         */
        public final B addSerializerByCondition(
        ...
        /**
         * Adds a bundle of properties.
         * <p>
         * The precedence of serializers added through this method are subject to the
         * actual implementation of the bundle at {@link PlatformBundle#register(Builder)}.
         *
         ...
         * @see PlatformBundle
         */
        public final B addBundle(PlatformBundle bundle) {
            requireNonNull(bundle, "bundle");
            bundle.register(getThis());
            return getThis();
        }
